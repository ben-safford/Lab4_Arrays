...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
	...
	//the code for printing the array was like two functions up, i just moved it here
   ...
   */
   ...
   {
    // Write your code here:
	  int minimum = 81; //can't go over 80 when setting array so 81 will always be max
      for ( int i = 0; i < 4; i++ )
      {
